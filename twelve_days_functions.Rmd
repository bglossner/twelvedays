...
sing_line <- function(dataset, line, phrase_col){
  ...
  # rev found from googling: "reverse vector r" -- https://stat.ethz.ch/R-manual/R-patched/library/base/html/rev.html
  ...
  if (line > 1) {
    phrases[length(phrases)] <- paste("and",
                                      str_replace(phrases[length(phrases)],
                                                  "one ", ""))
  }
